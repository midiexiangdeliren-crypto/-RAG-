---
 ...
 "id": "obt/memory/story_therex_1_1",
 "title": "THRM-EX·炙热冲击！",
 "type": "悖论模拟",
 "activity": "悖论模拟",
 "code": null,
 "summary": "在一次外勤任务中，Thermal-EX的表现超越了博士的预期。机器人的行为不再符合计算结果，这或许不是一个巧合。"
...
**【选择】** 等Thermal-EX完成数据传输，这些资料就能交给你，代表先生。
...
**【选择】** 这是短时间内输出能量强度过高引起的其余功能模块暂时失灵。 ／ 过几分钟就好，不必惊慌。
...
**【选择】** 打人的事都是Thermal-EX干的。 ／ …… ／ 那家公司给我们设套，最后自作自受而已。
...
**【选择】** 所以他们需要挑交易完成前的时间点下手。 ／ 所以那个医药公司的人才会适时晕倒。 ／ 所以他们并不想追那些“已经”落到自己人手里的软盘。
...
**【选择】** 但Thermal-EX能拥有这样独特的个性，这本身是一个巧合。
